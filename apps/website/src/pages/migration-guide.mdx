...
| listsPrefixesRenderers         | customListStyleSpecs                              | The API has changed, see [Lists, customization](./content/lists##defining-and-customizing-markers-pseudo-elements). |
...
| ------------------------------------------- | --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `htmlAttribs`                               | `tnode.attributes`                            | The TNode is the intermediary representation of the element to render. See [Architecture](./architecture).                                                                                                                                                                             |
