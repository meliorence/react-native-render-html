...
description: An overview of the exciting new features in React Native Render HTML Foundry release.
...
- **Unrecognized styles** crashing the the app. The new CSS processor is strict and
deterministic and what is translatable to React Native styles and what is not.
