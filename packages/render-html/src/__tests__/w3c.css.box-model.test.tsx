 ...
 *
 **/
describe.skip('RenderHTML component should honor formatting context of the DOM tree', () => {
  it('should wrap text elements into a box formed by a View component', () => {
    const { getByText } = render(
      <RenderHTML html={'<span>hello world</span>'} />
    );
  ...
  it('should wrap sibling text elements into a box formed by a Text component', () => {
    const { getByText } = render(
      <RenderHTML html={'<span>hello world</span><span>foo bar</span>'} />
    );
  ...
  //     <RenderHTML
  //       html={
  //         'foo<custom><b>hello world</b><img src="https://img.com/1" /></custom>'
  //       }
