    ...
    <FeatureTemplate>
      <ArticleHeaderAtom
        ...
        <BodyParagraphAtom>
          ...
          element renderer. <BodyRefHtmlElementMolecule name="picture" /> is not
          yet supported.
        </BodyParagraphAtom>
      ...
      <BodyChapterMolecule title={'Scaling'}>
        ...
        <BodyTipBoxAtom>
          ...
          <BodyRefRenderHtmlPropMolecule name="contentWidth" /> property from{' '}
        ...
        <BodyParagraphAtom>
          ...
          <BodyRefRenderHtmlPropMolecule name="contentWidth" />, or disabling
          scaling by returning <BodyRefJSSymbolMolecule name="Infinity" />.
        </BodyParagraphAtom>
        <RenderHtmlCardOrganism
          caption={
      ...
      <BodyChapterMolecule title="Preloading">
        <BodyParagraphAtom>
          ...
          <BodyRefHtmlAttrMolecule name="height" /> attributes are provided, or
          the two dimensions are set in the{' '}
          <BodyRefHtmlAttrMolecule name="style" /> attribute. This is great to
          avoid images "jumping" from zero height to their computed height, and
          is a hint to good web design.
        </BodyParagraphAtom>
      </BodyChapterMolecule>
